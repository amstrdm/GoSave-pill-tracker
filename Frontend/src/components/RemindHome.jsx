...
function RemindHome() {
    ...
    function handleRemindHomeInfo(){

    }

    return (
      <button className="btn mt-12 ml-5 mr-5 flex items-center justify-center space-x-2 p-2 min-w-[200px]" onClick={handleRemindWhenHome}>
          {isLoading ? (
              <>
